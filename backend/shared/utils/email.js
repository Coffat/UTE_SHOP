 ...
 * @param {string} toEmail - Địa chỉ email đích
 * @param {string} otpCode - Mã OTP 6 chữ số
 * @param {'register'|'reset'} type - Loại OTP để tuỳ chỉnh tiêu đề
 */
export const sendOtpEmail = async (toEmail, otpCode, type = 'register') => {
