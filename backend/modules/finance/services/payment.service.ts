...
import { PaymentStrategyFactory } from './strategies/PaymentStrategyFactory.ts';
import mongoose from 'mongoose';

/**
 * Called by order.service.js in an ACID transaction
 */
/**
 * Called by order.service.js in an ACID transaction
 */
...
export const confirmPayment = async (paymentId: string, transactionId: string) => {
