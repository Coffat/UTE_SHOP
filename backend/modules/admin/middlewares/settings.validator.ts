...
export const validateUpdateSettings = [
  ...
  body('ghnApiUrl').optional().isString().trim(),
  body('ghnApiToken').optional().isString().trim(),
  body('ghnShopId').optional().isString().trim(),
  body('ghnFromDistrictId').optional().isInt({ min: 0 }),
