 ...
 * @returns {{ discountAmount: number, voucher: Object }}
 */
export const validateAndCalculateVoucher = async (code, orderTotal) => {
 ...
 */
export const markVoucherUsed = async (voucherId, session = null) => {
...
export const createVoucher = async (data) => Voucher.create(data);

export const getVouchers = async () => Voucher.find().populate('campaign', 'name');

export const toggleVoucher = async (id, isActive) =>
  Voucher.findByIdAndUpdate(id, { isActive }, { new: true });
